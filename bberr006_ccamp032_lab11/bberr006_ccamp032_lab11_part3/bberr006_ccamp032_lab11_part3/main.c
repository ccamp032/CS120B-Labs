 ...
 *  Combine the functionality of the keypad and LCD so when keypad is 
 *  pressed and released, the character of the button pressed is displayed 
 *	on the LCD, and stays displayed until a different button press occurs 

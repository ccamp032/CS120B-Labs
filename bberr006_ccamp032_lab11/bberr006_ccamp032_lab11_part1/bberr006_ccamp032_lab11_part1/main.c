 ...
 *  Modify the keypad code to be in an SM task. Then, modify 
 *  the keypad SM to utilize the simple task scheduler format
 *  (refer to PES Chp 7). All code from here on out should use 
 *	the task scheduler. 
 *	

 ...
 *	display the message "CS120B is Legend... wait for it DARY!" The 
 *	string will not fit on the display all at once, so you will need 
 *	to come up with some way to paginate or scroll the text.
 *	
